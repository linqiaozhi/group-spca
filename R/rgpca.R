...
#' @export
rgpca <- function(X, k=NULL, alpha=1e-4, beta=1e-4, center=TRUE, scale=FALSE, max_iter=1000, tol=1e-5, o=20, q=2, verbose=TRUE, group_membership = NULL) UseMethod("rgpca")

#' @export
rgpca.default <- function(X, k=NULL, alpha=1e-4, beta=1e-4, center=TRUE, scale=FALSE, max_iter=1000, tol=1e-5, o=20, q=2, verbose=TRUE, group_membership = NULL) {
